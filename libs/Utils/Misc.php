...
class Misc
{
     ...
     * @param bool $returnWithArgs If true, returns command with the agruments
     ...
     * Ex : echo 'cheva'.Misc::pluralize(5, 'ux', '1'); ==> prints chevaux
     * Ex : echo 'cheva'.Misc::pluralize(1, 'ux', '1'); ==> prints cheval
     *
     * @param int $nb Number
     ...
     * @param bool True if the port is open else false
     */
