...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive ace-save-state">
        ...
        <ul class="nav nav-list">
            ...
            <li>
                <a href="{{ URL::to('/update_collection') }}">
                    <i class="menu-icon glyphicon glyphicon-indent-left"></i>
                    <span class="menu-text">Cập nhật dữ liệu</span>
                </a>
                <b class="arrow"></b>
            </li>
            <li>
                <a href="{{ URL::to('/status_collection') }}">
                    <i class="menu-icon fa fa-recycle"></i>
                    <span class="menu-text">Trạng thái dữ liệu</span>
                </a>
                <b class="arrow"></b>
            </li>
            <li>
                <a href="{{ URL::to('/index_collection') }}">
                    <i class="menu-icon fa fa-hand-pointer-o"></i>
                    <span class="menu-text">Đánh chỉ mục</span>
                </a>
                <b class="arrow"></b>
            </li>
            <li>
                <a href="{{ URL::to('/evaluate') }}">
                    <i class="menu-icon fa fa-bar-chart-o"></i>
                    <span class="menu-text">Đánh giá dữ liệu</span>
                </a>
                <b class="arrow"></b>
            </li>
        </ul><!-- /.nav-list -->
...
<!------------------------------------------------------------------------------------------------------------->
    <div class="main-content">
        <div class="main-content-inner">
            @yield('content')
            <div class="margin-20">@include('layouts.info')</div>
        </div>
    </div><!-- /.main-content -->
<!------------------------------------------------------------------------------------------------------------->
    <div class="footer">
