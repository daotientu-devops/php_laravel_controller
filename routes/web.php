 ...
 * Evaluate
 */
Route::get('/evaluate', 'DatabaseController@evaluate');
Route::post('/note_evaluate/{id}', 'DatabaseController@noteEvaluate');
/**
 * Auto update data collection
 */
Route::get('/update_collection', 'DatabaseController@getCollection');
Route::post('/update_collection', 'DatabaseController@postCollection');


/**
 * State documents
 */
Route::get('/status_collection', 'DatabaseController@statusCollection');

/**
 * Index Collection
 */
Route::get('/index_collection', 'DatabaseController@indexCollection');
Route::post('/index_collection', 'DatabaseController@postIndex');
Route::get('/index_all', 'DatabaseController@indexAll');